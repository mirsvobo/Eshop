...
public class Product {
    ...
    @Version @Column(length = 100) private Integer version; // Poznámka: @Column(length=100) zde asi nemá smysl pro @Version
    ...
    @OneToOne(mappedBy = "product", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY) // Přidáno FetchType.LAZY pro konzistenci
