...
public class OrderItem {
    ...
    @Column(length = 100) private String material; // Základní materiál z produktu
    @Column(precision = 10, scale = 2) private BigDecimal height; // Finální výška (z produktu nebo custom)
    @Column(precision = 10, scale = 2) private BigDecimal width;  // Finální hloubka
    @Column(precision = 10, scale = 2) private BigDecimal length; // Finální délka
    @Column(length = 100) private String glaze; // Finální lazura (vybraná nebo custom)
    @Column(length = 100) private String roofColor; // Finální barva střechy
    @Column(length = 100) private String roofOverstep; // Finální přesah
    // *** NOVÉ POLE: 'design' je nyní jen pro textový vstup u custom ***
    @Column(length = 100) private String design; // Textový design zadaný u custom produktu
    ...
    @Column(nullable = false, precision = 10, scale = 2) private BigDecimal totalTaxAmount;
    @Column(nullable = false, precision = 10, scale = 2) private BigDecimal totalPriceWithTax;
